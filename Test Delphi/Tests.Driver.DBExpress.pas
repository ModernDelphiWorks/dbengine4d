...
begin
  ...
  FConnection.Params.Add('Database=.\database.db3');
  FConnection.Params.Add('FailIfMissing=True');

  FDBConnection := TFactoryDBExpress.Create(FConnection, dnSQLite);
end;
