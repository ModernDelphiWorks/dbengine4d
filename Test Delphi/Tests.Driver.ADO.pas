...
begin
  ...
  FConnection.ConnectionString := 'Provider=MSDASQL.1;Persist Security Info=False;Data Source=ODBC SQLite';
  FConnection.LoginPrompt := False;

  FDBConnection := TFactoryADO.Create(FConnection, dnSQLite);
end;
